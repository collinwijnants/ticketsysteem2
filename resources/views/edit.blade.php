...
<body>
  ...
  <div class="card">
    ...
    <div class="card-body">
      <form name="eventform" id="eventform" method="post" action="{{route('update', $post->id)}}">
       @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" id="image" name="image" class="form-control" accept="image/jpg , image/gif, image/jpeg" value="{{$post->photo}}">
        </div>
        <div class="form-group">
